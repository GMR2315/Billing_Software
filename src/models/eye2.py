...
def detect_real_face_movement(landmarks):
    ...
    return average_movement > movement_threshold
...
def generate_frames():
    ...
    cap.set(cv2.CAP_PROP_FPS, 30)  # Set a reasonable frame rate
    ...
    while True:
        ...
        gray_frame = cv2.cvtColor(frame, cv2.COLOR_BGR2GRAY)  # Convert to grayscale for faster processing
